...
class DownlaodCouponList(val serviceInterface: DownloadServiceInterface):DownloadLayer<Coupon> {
    ...
    fun createList():List<Coupon>{
        ...
        list.add(Coupon("abrfed",Coupon.COUPON_TYPE,"MAXI hamburguer bread","https://images-na.ssl-images-amazon.com/images/I/51HpSRH1oaL._SX425_.jpg","20 days to finish",false
